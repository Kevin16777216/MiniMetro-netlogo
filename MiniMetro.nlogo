...
to setup
  ...
  while [m < 10][
    ...
    while [not canSpawn][
      ...
      ask nearest[
        if (distancexy rx ry) > (trackWidth * 3) and (ry > (min-pycor + (2 * trackWidth)))[
           set canSpawn true
        ]
      ]
      ][
...
to createTrain [initPath dir trainLine isFinalized]
  create-trains 1[
    set shape "train"
