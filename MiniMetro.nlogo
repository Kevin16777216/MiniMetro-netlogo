...
stations-own[
  ...
  stationID;
  connecting-lines; list of all lines that get here
]
breed[lines line]
lines-own[
  line-stations;list of all stations
  lineID
]
to setup
  ca
...
to generatePath [A B line-color]
  create-paths 1 [
    ...
    set stationA A
    set stationB B
    set pathID ((length pathIDList) - 1)
...
to generateStation [x y]
  create-stations 1 [
    ...
    set shape "target"
    set color white
    set stationID ((length stationsList) - 1)
